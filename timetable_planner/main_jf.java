...
public class main_jf extends javax.swing.JFrame {
    ...
    public main_jf() throws IOException {

        initComponents();
        Dimension scsz = Toolkit.getDefaultToolkit().getScreenSize();
        this.setBounds(0, 0, scsz.width, scsz.height);
        //this.pack();
        this.setIconImage(new ImageIcon(getClass().getResource("tt_icon.png")).getImage());

        this.setDefaultCloseOperation(main_jf.DO_NOTHING_ON_CLOSE);
        addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent we) {
                String ObjButtons[] = {"Yes", "No"};
                int PromptResult = JOptionPane.showOptionDialog(null, "Are you sure you want to exit?", "Timetable Planner", JOptionPane.DEFAULT_OPTION, JOptionPane.WARNING_MESSAGE, null, ObjButtons, ObjButtons[1]);
    ...
    private void b_prescribedActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_prescribedActionPerformed
        try {
           ...
           JOptionPane.showMessageDialog(null,"Sorry you cannot proceed,you must have deleted files from the Timetable planner directory!, please reinstall the software");
    ...
    private void b_saveldActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_b_saveldActionPerformed
        ...
        if (res == JOptionPane.YES_OPTION) {
            ...
            for (int i = 0; i < sem[sem_i - 1].sec[sec_i - 1].nol; i++) {
                if (sem[sem_i - 1].sec[sec_i - 1].l[i].l_teach[0].equals("") || sem[sem_i - 1].sec[sec_i - 1].l[i].l_teach[0].equals("Select Teacher-->")
                        || sem[sem_i - 1].sec[sec_i - 1].l[i].l_teach[0].equals(null)) {
...
//            jButton7.setVisible(false);
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        JOptionPane.showMessageDialog(null, "Developers:SIDOTA(Siddiq & Motasim)");
...
// prints "com.oyoaha.swing.plaf.oyoaha.OyoahaLookAndFeel"
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "File missing,please reinstall");
                }
    ...
    private void display_tt() throws IOException {
        ...
        for(int i=0;i<5;i++)
        {
            temp_tt[i][2]=br.substring(i,i+1);
            temp_tt[i][5]=ln.substring(i,i+1);
        }
    ...
    private void produce_teachf(int sub_in) {
        ...
        for(int i=0;i<5;i++)
        {
            temp_teach_f[i][2]=br.substring(i,i+1);
            temp_teach_f[i][5]=ln.substring(i,i+1);
        }
